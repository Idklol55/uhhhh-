	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'sans':
				...
				animation.addByPrefix('idle', 'Sans FNF instance 1', 24, true);
				...
				animation.addByPrefix('idle-alt', 'Sans FNF 02 instance 1', 24, true);
				...
				animation.addByPrefix('UTmode', 'Switch to UT mode instance 1', 24, false);
				animation.addByPrefix('SansDodge', 'SansDodge instance 1', 24, false);

				addOffset('idle');
				addOffset("singUP", -17, 27);
				addOffset("singRIGHT", -18, -1);
				addOffset("singLEFT", 49, -1);
				addOffset("singDOWN", -13, -15);
				addOffset('idle-alt', -15, -1);
				addOffset("singUP-alt", 35, 28);
				addOffset("singRIGHT-alt", -17, -2);
				addOffset("singLEFT-alt", 47, 0);
				addOffset("singDOWN-alt", -13, -16);
				addOffset("UTmode", 19, -1);
				addOffset("SansDodge", 59, 58);
